...
const PostModal: FC<IPostModalProps> = ({
  customCss,
}) => {

  const {showModal, setShowModal, mode} = useContext(PostModalContext) as PostModalContextType;
  ...
  return (
    ...
    bg-gray-500/50 backdrop-blur-lg 
    ${showModal?'flex':'hidden'} justify-center items-center`}>
    <div
         className={`
         ${mode==='mobile'?'-mt-28 -mb-1':''}
        m-auto
